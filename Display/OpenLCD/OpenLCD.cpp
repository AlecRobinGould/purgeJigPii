/*
  ...
  By: Nathan Seidle - With mods by Alec R Gould
  ...
  v14 Alec mods
    Splash screen now stays on until the display is updated by new information.
    Reinstantiation of the display in the custom charatcer member was removed. This was determined to be the
    root of a few bugs.
*/
